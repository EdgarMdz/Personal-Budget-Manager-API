...
namespace PersonalBudgetManager.Api.DataContext.Migrations
{
    ...
    [Migration("20250128040238_UserRolesTableCreated")]
    partial class UserRolesTableCreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalBudgetManager.Api.DataContext.Entities.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PersonalBudgetManager.Api.DataContext.Entities.User", b =>
                {
                    b.HasOne("PersonalBudgetManager.Api.DataContext.Entities.UserRole", "Role")
                        .WithMany("Users")
